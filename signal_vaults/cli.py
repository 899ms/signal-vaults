...
def _print_env():
    print("SIGNAL_VAULTS_DB_DIR     =", config.DB_DIR or "(未设置, 将自动检测)")
    print("SIGNAL_VAULTS_KEYS_FILE  =", config.KEYS_FILE or "(默认 ~/.wechat-cli/all_keys.json)")
    print("SIGNAL_VAULTS_WORK_DIR   =", config.WORK_DIR)
